...
const FETCH_LIMIT = typeof process.env.FETCH_LIMIT !== 'undefined' ? parseInt(process.env.FETCH_LIMIT) : 5
const START_HEIGHT = process.env.START_HEIGHT || (NETWORK === 'test' ? 1477070 : 650000)
...
const DEFAULT_TRUSTLIST = ENV_VAR_DEFAULT_TRUSTLIST || [
  ...
  'ef15f20e311f9b34d016c7e82cc797763265b044a2e3005f6803941954608fda', // group
]

const PROD_TRUSTLIST = [
	 /**
   * RUN ▸ Extras
   */
